...
- [ ] ID-41 [PriceFeedL2.\_checkSequencerUptimeFeed()](contracts/Pricing/PriceFeedL2.sol#L71-L103)
      ignores return value by
      [(None,answer,None,updatedAt,None) = ChainlinkAggregatorV3Interface(sequencerUptimeFeedAddress).latestRoundData()](contracts/Pricing/PriceFeedL2.sol#L74-L82)
...
- [ ] ID-83 [FeeCollector.getProtocolRevenueDestination()](contracts/FeeCollector.sol#L197-L199) has
      external calls inside a loop:
...
- [ ] ID-113 [LockedTREN.sendTRENTokenToEntity(address)](contracts/TREN/LockedTREN.sol#L101-L110)
      uses timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-120 [CommunityIssuance.issueTREN()](contracts/TREN/CommunityIssuance.sol#L106-L124) uses
      timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-122 [FeeCollector.collectFees(address[],address[])](contracts/FeeCollector.sol#L160-L188)
      uses timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-124 [PriceFeedL2.\_checkSequencerUptimeFeed()](contracts/Pricing/PriceFeedL2.sol#L71-L103)
      uses timestamp for comparisons Dangerous comparisons: -
      [timeSinceSequencerUp <= delay](contracts/Pricing/PriceFeedL2.sol#L99)

contracts/Pricing/PriceFeedL2.sol#L71-L103

- [ ] ID-125 [LockedTREN.getClaimableTREN(address)](contracts/TREN/LockedTREN.sol#L120-L135) uses
      timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-126 [TrenBoxManager.\_updateLastFeeOpTime(address)](contracts/TrenBoxManager.sol#L850-L858)
      uses timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-129 [LockedTREN.isEntityExits(address)](contracts/TREN/LockedTREN.sol#L141-L143) uses
      timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-134 [LockedTREN.transferUnassignedTREN()](contracts/TREN/LockedTREN.sol#L112-L118) uses
      timestamp for comparisons Dangerous comparisons: -
...
- [ ] ID-137 3 different versions of Solidity are used: - Version constraint ^0.8.23 is used by: -
      contracts/ActivePool.sol#2 - contracts/AdminContract.sol#2 -
      contracts/BorrowerOperations.sol#2 - contracts/CollSurplusPool.sol#2 -
      contracts/DebtToken.sol#2 - contracts/DefaultPool.sol#2 -
      contracts/Dependencies/ConfigurableAddresses.sol#3 -
      contracts/Dependencies/SafetyTransfer.sol#3 - contracts/Dependencies/TrenBase.sol#2 -
      contracts/Dependencies/TrenMath.sol#3 - contracts/FeeCollector.sol#2 -
      contracts/FlashLoan.sol#2 - contracts/GasPool.sol#3 - contracts/Interfaces/IActivePool.sol#2 -
      contracts/Interfaces/IAdminContract.sol#2 - contracts/Interfaces/IBorrowerOperations.sol#3 -
      contracts/Interfaces/ICollSurplusPool.sol#2 - contracts/Interfaces/ICommunityIssuance.sol#3 -
      contracts/Interfaces/IDebtToken.sol#3 - contracts/Interfaces/IDefaultPool.sol#3 -
      contracts/Interfaces/IDeposit.sol#2 - contracts/Interfaces/IERC20Decimals.sol#3 -
      contracts/Interfaces/IFeeCollector.sol#3 - contracts/Interfaces/IFlashLoan.sol#2 -
      contracts/Interfaces/IFlashLoanReceiver.sol#2 - contracts/Interfaces/ILockedTREN.sol#2 -
      contracts/Interfaces/IPool.sol#2 - contracts/Interfaces/IPriceFeed.sol#3 -
      contracts/Interfaces/IPriceFeedL2.sol#2 - contracts/Interfaces/ISortedTrenBoxes.sol#3 -
      contracts/Interfaces/IStabilityPool.sol#3 - contracts/Interfaces/ITRENStaking.sol#2 -
      contracts/Interfaces/ITrenBoxManager.sol#2 -
      contracts/Interfaces/ITrenBoxManagerOperations.sol#2 -
      contracts/Interfaces/IUniswapRouterV3.sol#2 - contracts/PriceFeed.sol#3 -
      contracts/Pricing/API3ProxyInterface.sol#2 - contracts/Pricing/FixedPriceAggregator.sol#2 -
      contracts/Pricing/PriceFeedL2.sol#2 - contracts/Pricing/SfrxEth2EthPriceAggregator.sol#2 -
      contracts/Pricing/WstEth2UsdPriceAggregator.sol#2 - contracts/SortedTrenBoxes.sol#3 -
      contracts/StabilityPool.sol#3 - contracts/TREN/CommunityIssuance.sol#2 -
      contracts/TREN/LockedTREN.sol#2 - contracts/TREN/TRENStaking.sol#2 -
      contracts/TREN/TRENToken.sol#3 - contracts/TestContracts/ERC20Test.sol#3 -
      contracts/TestContracts/FlashLoanTester.sol#2 - contracts/TestContracts/MockAggregator.sol#2 -
      ...
      contracts/TestContracts/TrenMathTester.sol#2 - contracts/Timelock.sol#2 -
      contracts/TrenBoxManager.sol#2 - contracts/TrenBoxManagerOperations.sol#2 - Version constraint
      ^0.8.0 is used by: -
      node_modules/@chainlink/contracts/src/v0.8/interfaces/AggregatorV3Interface.sol#2 - Version
      constraint ^0.8.20 is used by: -
...
- [ ] ID-139 Variable [AdminContract.CCR_DEFAULT](contracts/AdminContract.sol#L30) is too similar to
...
- [ ] ID-145 The following unused import(s) in
      node_modules/@openzeppelin/contracts/interfaces/IERC20.sol should be removed: -import {IERC20}
      from "../token/ERC20/IERC20.sol";
      (node_modules/@openzeppelin/contracts/interfaces/IERC20.sol#6)

- [ ] ID-146 The following unused import(s) in contracts/TestContracts/MockUniswapRouterV3.sol
      should be removed: -import { IERC20 } from "@openzeppelin/contracts/interfaces/IERC20.sol";
      (contracts/TestContracts/MockUniswapRouterV3.sol#4)

- [ ] ID-147 The following unused import(s) in
      node_modules/@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol should be removed:
      -import {IERC20Permit} from "../extensions/IERC20Permit.sol";
      (node_modules/@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol#7)
